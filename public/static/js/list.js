	...
	success:function(res) {
		...
		if( res.code == 1){
			...
			$.each(data, function(index, val) {
				...
				$(s).append("\
					<li class=\"ui-border-t\" onclick=\"location.href= \'" + val.user_url_text +"\'\">\
	                    <div class=\"ui-list-info\">\
	                        <h4 class=\"ui-nowrap\">" + val.id + ". <span class=\"ui-txt-warning\">" + val.username + "</span> / " + val.surplus + " / " + val.active_text + "</h4>\
	                        <p class=\"ui-nowrap\">" + val.end_time_text + " / " + val.bytes_sent_deal + " / " + val.bytes_received_deal + "</p>\
	                    </div>\
	                </li>\
				");
				i++;
